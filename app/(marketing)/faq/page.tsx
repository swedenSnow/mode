...
export default function FAQPage() {
  return (
    <div className="container mx-auto px-4 py-12 text-gray-400 dark:text-gray-300">
      <h2 className="text-2xl font-bold mb-8 text-center text-gray-400 dark:text-gray-300">
